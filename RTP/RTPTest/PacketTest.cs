...
namespace RTPTest
{
    ...
    public class PacketTest
    {
        ...
        public void PacketRaw()
        {
            ...
            Assert.AreEqual("80;99;10;666;message", smg.ActualSegment.ToString());
        }
        ...
        {
            Packet smg = new Packet("192.168.1.1;192.168.1.2;80;99;10;666;message");
            Assert.AreEqual("192.168.1.1;192.168.1.2;80;99;10;666;message", smg.ToString());
        }
        ...
        {
            Packet smg = new Packet("192.368.1.1;192.168.1.2;80;99;666;message");
